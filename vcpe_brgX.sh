...
# curl -X POST -d '{"port_name": "vxlan1", "type": "linux-htb", "max_rate": "6000000", "queues": [{"max_rate": "2000000"}, {"min_rate": "2000000"}]}' http://:8080/qos/queue/0000000000000001
# curl -X POST -d '{"match": {"nw_dst": "10.2.2.2", "nw_proto": "UDP", "tp_dst": "3000"}, "actions":{"queue": "1"}}' http://10.250.0.22:8080/qos/rules/0000000000000001
...
iperf -c 192.168.255.20 -p 3000 -u -b 12M -l 1400 

curl -X PUT -d '"tcp:127.0.0.1:6632"' http://172.17.0.2:8080/v1.0/conf/switches/0000000000000001/ovsdb_addr
curl -X POST -d '{"port_name": "vxlan2", "type": "linux-htb", "max_rate": "12000000", "queues": [{"max_rate": "4000000"}, {"min_rate": "8000000"}]}' http://172.17.0.2:8080/qos/queue/0000000000000001
...
iperf -c 192.168.255.1 -p 7000 -u -b 6M -l 1400
